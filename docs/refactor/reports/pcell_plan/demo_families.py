...
CONFIGS = {
    "clean_port_ind_sym": {"port_order": ["P1", "N1", "CT"], "outer_diameter_um": 100.0, "width_um": 5.0, "spacing_um": 2.0, "opening_um": 8.0,
                           "lead_length_um": 20.0, "turns": 2, "metal": "6", "ct_metal": "4"},
    ...
    "clean_port_xfm_ms": {"port_order": P4, "primary_outer_diameter_um": 100.0, "secondary_outer_diameter_um": 76.0, "primary_width_um": 6.0,
